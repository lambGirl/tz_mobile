...
var _easyscroll = _interopRequireDefault(require("../common/easyscroll"));
...
function (_Component) {
  ...
  _createClass(DH, [{
    ...
    value: function renderMonth(monthArr) {
      ...
      return _react.default.createElement(_easyscroll.default, {
    ...
    value: function renderDate(item, index) {
      ...
      return _react.default.createElement("div", {
        ...
        var ClassStr,
            ...
            // allow = day.allow,
        classActiveStr = ""; //allow && ( ClassStr = 'DH-month-date-allow');

        var _BreakData = _this4._BreakData(dataStr),
            allow = _BreakData.playContent; // console.log("day", _BreakData);


        allow && (ClassStr = 'DH-month-date-allow');
        _this4._algorithm(dataStr) && allow && (classActiveStr = 'DH-active-date'); // console.log("-------------day----------",model != 'common');

        return _react.default.createElement("div", {
          className: (0, _classnames.default)(_date.default[ClassStr], _defineProperty({}, _date.default["".concat(model)], model != 'common')),
          key: daIndex + '_day*/',
        ...
        }, dataStr == new Date().format("yyyy-MM-dd") ? _react.default.createElement("span", {
          className: _date.default["cn_fontSize"]
        }, "\u4ECA\u5929") : _react.default.createElement("span", {
          className: _date.default["en_fontSize"]
        }, day.date), _react.default.createElement("div", {
          className: _date.default["tip"]
        }, _BreakData.playContent)));
      }));
    }
    /*切换日期,多选择*/
