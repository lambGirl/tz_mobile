...
function (_Component) {
  ...
  _createClass(DH, [{
    ...
    value: function renderMonth(monthArr) {
      ...
      return _react.default.createElement(_easyscroll.default, {
        ...
        return _react.default.createElement("div", {
          ...
          className: new Date().getLoactionTime()["FullYear"] == item.FullYear && item.Month == new Date().getLoactionTime()["Month"] ? "DH-month-title" : "DH-month-title color3E3E3E"
    ...
    value: function renderDate(item, index) {
      ...
      return _react.default.createElement("div", {
        ...
        return _react.default.createElement("div", {
          ...
          className: classActiveStr
        }, _react.default.createElement("div", {
          className: "tip"
        }, _BreakData.playContent), dataStr == new Date().format("yyyy-MM-dd") ? _react.default.createElement("span", {
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: (0, _classnames.default)("DH-main", this.props.defineClass)
        ...
        return _react.default.createElement("div", {
          key: item.toString(),
          className: "DH-week-item ".concat(index == "0" || index == "6" ? " colorFC5151" : '')
        }, item);
