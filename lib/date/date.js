  ...
  _createClass(DH, [{
    ...
    value: function renderMonth(monthArr) {
      ...
      return _react.default.createElement("div", {
        className: (0, _classnames.default)(_date.default['scroll-content'], _date.default["defaultHeight"])
      }, _react.default.createElement(_index.default, {
        class: _date.default['wrapper']
      }, _react.default.createElement("div", {
        className: _date.default['scroll-cotent-bottom']
      }, _react.default.createElement("div", {
    ...
    value: function renderDate(item, index) {
      ...
      return _react.default.createElement("div", {
        ...
        if (model !== 'common') {
          _BreakSellDetial = _this4._BreakSellDetial(dataStr);
        ...
        return _react.default.createElement("div", {
          ...
          key: daIndex + '_day*/',
          onClick: allow ? _this.props.type == "common" && _this4.toggleDate.bind(_this4, dataStr) || _this4.chooseSingle.bind(_this4, dataStr, _BreakSellDetial) : null
        }, _react.default.createElement("div", {
        ...
        }, _BreakSellDetial.content && "\xA5".concat(_BreakSellDetial.content))));
      }));
    }
    /*切换日期,多选择*/
    ...
    key: "chooseSingle",
    value: function chooseSingle(date, tag) {
    ...
    key: "_BreakSellDetial",
    value: function _BreakSellDetial(dataStr) {
      var sellDetail = this.props.sellDetail,
          _BreakSellDetial = {
        tag: false,
        content: ''
      };

      for (var i = 0, len = sellDetail.length; i < len; i++) {
